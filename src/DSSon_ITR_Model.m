...
%   for FRED-Data
%
%   Individual Target Range Model
%
%   by Paul Vickers and Robert Höldrich
%   -----------------------------------
%
...
for sound=1:3
    ...
    for ii=1:n_pos-1 % only up to pos-1, because of discontinuity at the end of the some data vector.
    ...
    if plot_flag
        ...
        axes1 = axes('Parent',figure2,...
            ...
            'CLim',[-80 -30]);
        %% Uncomment the following line to preserve the X-limits of the axes
        xlabel('Time (s)','FontSize',28,'Position',[2 275]);
        set(gca,'layer','top');
        xlim(axes1,[0 4]);
        %% Uncomment the following line to preserve the Y-limits of the axes
        ylim(axes1,[300 1100]);
        for ii=0:1
            line([0;4],[400*2^ii;400*2^ii],'LineWidth',0.5,'LineStyle','- -','Color',0*[1 1 1]);
